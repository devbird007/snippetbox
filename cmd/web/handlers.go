...
func home(w http.ResponseWriter, r *http.Request) {
	...
	// and store the templates in a template set. Notice that we can pass the slice of the file paths as a variadic parameter?
	...
	// Use the ExecuteTemplate() method to write the content of
	// the "base" template as the response body.
